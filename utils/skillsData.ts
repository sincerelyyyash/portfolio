...
export const skills = {
  default: [
    ...
    { skill: "PostgreSQL", img: "/path/to/postgresqlimg.png" },
    { skill: "MongoDB", img: "/path/to/postgresqlimg.png" },
    { skill: "NodeJS", img: "/path/to/postgresqlimg.png" },
    { skill: "Typescript", img: "/path/to/postgresqlimg.png" },
    { skill: "Javascript", img: "/path/to/postgresqlimg.png" },
    { skill: "Turborepo", img: "/path/to/postgresqlimg.png" },
  ...
  database: [
    { skill: "MongoDB", img: "/path/to/mongodbimg.png" },
    { skill: "PostgreSQL", img: "/path/to/postgresqlimg.png" },
    { skill: "MySQL", img: "/path/to/mysqlimg.png" },
    { skill: "Firebase", img: "/path/to/postgresqlimg.png" },
  ],
  tools: [
    { skill: "Docker", img: "/path/to/dockerimg.png" },
    { skill: "Git", img: "/path/to/gitimg.png" },
    { skill: "Github", img: "/path/to/postgresqlimg.png" },
